...
export function CartDrawer() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed right-0 top-0 z-[70] flex h-full w-full max-w-md flex-col bg-paper transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]",
                ...
                <li key={line.product.id} className="flex gap-4">
                  ...
                  <div className="flex flex-1 flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm">${line.product.price * line.quantity}</span>
                      <button
